...
#  * A failed probe is cached as NOTFOUND and never retried, which silently
#    pinned build directories to the CPU backend. A verified result is recorded
#    separately, so anything unverified is probed again on the next configure.
...
if(NOT (CMAKE_CUDA_COMPILER AND GNP_CUDA_VERIFIED_PAIR STREQUAL _gnp_pair))
    ...
    if(NOT _gnp_ok)
        ...
        message(WARNING
            ...
            "     ${_gnp_tried}\n"
            "     Falling back to the CPU poller.\n"
            ${_gnp_no_cuda_hint} "\n"
